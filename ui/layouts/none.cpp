...
terraformer::ui::layouts::none::row_array<float>
terraformer::ui::layouts::none::set_default_cell_sizes_to(
...
terraformer::ui::layouts::none::column_array<float>
terraformer::ui::layouts::none::set_default_cell_sizes_to(
	span<box_size const> sizes_in,
...
void terraformer::ui::layouts::none::set_default_cell_sizes_to(span<box_size const> sizes_in)
{
	if(sizes_in.empty())
	{ return; }
...
void terraformer::ui::layouts::none::adjust_cell_sizes(
...
void terraformer::ui::layouts::none::get_cell_sizes_into(
...
void terraformer::ui::layouts::none::get_cell_sizes_into(span<box_size> sizes_out) const
{
	switch(m_cell_order)
	{
		case cell_order::row_major:
...
void terraformer::ui::layouts::none::get_cell_locations_into(
...
void terraformer::ui::layouts::none::get_cell_locations_into(span<location> locs_out) const
{
	switch(m_cell_order)
	{
		case cell_order::row_major:
...
terraformer::box_size terraformer::ui::layouts::none::get_dimensions() const
{
