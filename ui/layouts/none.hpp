//@	{"dependencies_extra":[{"ref":"./none.o", "rel":"implementation"}]}
...
namespace terraformer::ui::layouts
{
	...
	public:
		...
		explicit none(size_t fixdim_size, cell_order cell_order):
