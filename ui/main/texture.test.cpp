...
TESTCASE(terraformer_ui_main_texture_default_is_not_created)
{
	...
	EXPECT_EQ(texture.created_by_factory(0), false);
}
...
TESTCASE(terraformer_ui_main_texture_create_factory_id_1_is_created_by_factory_1)
{
	...
	EXPECT_EQ(texture.created_by_factory(0), false);
	EXPECT_EQ(texture.created_by_factory(1), true);
	EXPECT_EQ(texture.created_by_factory(2), false);

	EXPECT_EQ(calls_to_bind, 0);
	EXPECT_EQ(calls_to_upload, 0);
}

TESTCASE(terraformer_ui_main_texture_move_construct_preserves_created_by_factory)
{
	size_t calls_to_bind{0};
	size_t calls_to_upload{0};
	terraformer::ui::main::texture texture{std::in_place_type_t<dummy_texture>{}, 1, calls_to_bind, calls_to_upload};
	...
	EXPECT_EQ(other.created_by_factory(0), false);
	EXPECT_EQ(other.created_by_factory(1), true);
	EXPECT_EQ(other.created_by_factory(2), false);
	EXPECT_EQ(texture.created_by_factory(0), false);
	EXPECT_EQ(texture.created_by_factory(1), false);
	EXPECT_EQ(texture.created_by_factory(2), false);
...
TESTCASE(terraformer_ui_main_texture_move_construct_move_assign_replaces_created_by_factory)
{
	size_t calls_to_bind{0};
	size_t calls_to_upload{0};
	terraformer::ui::main::texture texture{std::in_place_type_t<dummy_texture>{}, 1, calls_to_bind, calls_to_upload};
	...
	EXPECT_EQ(other.created_by_factory(0), false);
	EXPECT_EQ(other.created_by_factory(1), false);
	EXPECT_EQ(other.created_by_factory(2), true);
	EXPECT_EQ(texture.created_by_factory(0), false);
	EXPECT_EQ(texture.created_by_factory(1), true);
	EXPECT_EQ(texture.created_by_factory(2), false);
