...
{
	class range_slider:public float_input_controller<range_slider>
	{
	public:
		using float_input_controller<range_slider>::handle_event;

		using float_input_controller<range_slider>::float_input_controller;
