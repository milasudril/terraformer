...
namespace terraformer
{
	...
	public:
		...
		[[deprecated("Use element indices instead")]] constexpr auto first_element_index() const noexcept
		{ return index_type{}; }

		[[deprecated("Use element indices instead")]]  auto last_element_index() const noexcept
