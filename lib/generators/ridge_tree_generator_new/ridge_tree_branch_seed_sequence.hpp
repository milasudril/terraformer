...
{
	struct ridge_tree_branch_seed_sequence : multi_array<location, float, direction, displaced_curve::index_type, float>
	{
		using multi_array<location, float, direction, displaced_curve::index_type, float>::multi_array;
	};
