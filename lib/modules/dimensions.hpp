...
namespace terraformer
{
	...
	using horizontal_offset = bounded_value<closed_closed_interval{-131072.0f, 131072.0f}, 0.0f>;
	...
	using spline_gradient = bounded_value<closed_closed_interval{1.0f/16384.0f, 1024.0f}, 1.0f>;
}
